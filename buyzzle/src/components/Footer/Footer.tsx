...
export default function Footer() {
  return (
    <footer className="footer-bg mt-10">
      <div className="container mx-auto">
        ...
        <Container>
          <div className="relative">
            <div className="container mx-auto">
              <div className="txt-content flex mt-7 font-extrabold text-[#525252] text-base">
                <div className="w-full lg:w-1/2 xl:w-1/5">
                  <span>THANH TOÁN</span>
                  <div className="flex flex-wrap gap-2 w-full lg:w-[80%] mt-4">
                    <img src={Images.momo2} width={60} height={30} />
                    <img src={Images.zalopay} width={60} height={30} />
                  </div>
                </div>
                <div className="w-full lg:w-1/2 xl:w-1/5">
                  <span>ĐƠN VỊ VẬN CHUYỂN</span>
                  <div className="flex flex-wrap gap-2 w-full lg:w-[90%] mt-4">
                ...
                <div className="w-full lg:w-1/2 xl:w-1/3">
                  ...
                  <ul
                    role="list"
                    className="flex flex-wrap gap-2 w-full lg:w-[90%] mt-4"
                  >
                    <li>
                      <a
                        href="#"
                        className="flex space-x-3 hover:text-[#FFAAAF] transition"
                      >
                        <svg
                    ...
                    <li>
                      <a
                        href="#"
                        className="flex items-center space-x-3 hover:text-[#FFAAAF] transition"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="currentColor"
