        ...
        <body className="register-bg flex max-xl:flex-wrap">
          ...
          <div className="w-1/2 flex justify-center items-center min-h-screen bg-white ">
            <div className="w-[424px]">
              ...
              <h2 className="font-xacnhan">Xác nhận thành công</h2>
              <div className="mt-6 text-center">
                <span className="text-gray-600">
                  Xác nhận thông tin thành công vui lòng bấm vào tiếp tục để tận
                  hường mua hàng{" "}
                </span>
              </div>
              <Link to="/login">
                <button
                  type="submit"
                  className="w-[424px] bg-[#5D5FEF] text-white py-2 rounded-md hover:bg-[#2d2ff7] transition duration-300 mt-[25px]"
                >
                  Tiếp tục
                </button>
              </Link>
